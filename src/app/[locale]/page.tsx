...
import { AllBodyData, Connect, ContentDataTitle, ItemAbout, OurServerData, Project, TeamMember, Testimonial } from "@/components/type/typdata";
const Home: React.FC = () => {
